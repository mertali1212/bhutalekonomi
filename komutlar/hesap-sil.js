...
////Gum
  ...
  if (!kontrol) return message.channel.send('Bir Hesabın Bulunmuyor!') 

 
  message.channel.send(`Hesabın Silinsin mi ?`)
  ...
  message.channel.send(`Artık Bir hesabın Bulunmuyor!`)
}
